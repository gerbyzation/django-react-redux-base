...
describe('Data Actions:', () => {
    ...
    it('dataExecuteAsyncTask should DATA_RECEIVE_ASYNC_TASK_ERROR when API returns 500', (done) => {
        const expectedActions = [
            {
                type: TYPES.DATA_FETCH_ASYNC_TASK
            }, {
    ...
    it('dataExecuteAsyncTask should DATA_RECEIVE_ASYNC_TASK_ERROR when API has no response', (done) => {
        const expectedActions = [
            {
                type: TYPES.DATA_FETCH_ASYNC_TASK
            }, {
